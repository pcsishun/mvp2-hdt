<template>
    <div :class="$store.state.cssMenu"  >
        <div class="float-right mr-3 mt-3">
            <button @click="haddleCloseMenu">
        ...
        <div :class="$store.state.cssBodyMenu" >
            <div class="menu-m">
                <button class="flex" @click="haddleMebne('home')">
                    <div class="mr-3">
            ...
            <div class="menu-m mt-[40px]">
                <button class="flex" @click="haddleMebne('Setting')">
                    <div class="mr-3">   
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
